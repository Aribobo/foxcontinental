        ...
        >
          ...
          >
            ...
            <div className="py-4 px-6 bg-[#1f425d] ">
              ...
              <p className="text-start text-white">{t("air")}</p>
            </div>
          </div>
          <div
            id="ocean"
          ...
          >
            ...
            <div className="py-4 px-6 bg-[#1f425d] ">
              ...
              <p className="text-start text-white">{t("ocean")}</p>
            </div>
          </div>
          <div
            id="road"
         ...
         ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:duration-300"
          >
            ...
            <div className="py-4 px-6 bg-[#1f425d] ">
              ...
              <p className="text-start text-white">{t("road")}</p>
            </div>
          </div>
          <div
            id="warehouse"
          ...
          >
            ...
            <div className="py-4 px-6 bg-[#1f425d] ">
              ...
              <p className="text-start text-white">{t("warehouse")}</p>
            </div>
          </div>
          <div
            className="relative group shadow-gray-600 overflow-hidden  shadow-md ml-2 mr-2 
          ...
          >
            ...
            />
            <div className="py-4 px-6 bg-[#1f425d] ">
              <p className=" text-start text-white text-2xl">{t("rail")}</p>
              <p className="text-start text-white">{t("continental")}</p>
            </div>
          </div>
          <div
            id="custom"
          ...
          >
            ...
            <div className="py-4 px-6 bg-[#1f425d] ">
              ...
              <p className="text-start text-white">{t("broker")}</p>
            </div>
          </div>
        </div>
      </div>
