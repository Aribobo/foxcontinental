...
const Track = () => {
    ...
    return(
        ...
        type="text"
        id="Track"
        className="mt-1 w-50 block lg:w-45 px-3 py-2 pb-2 border border-[#1f425d] rounded-md shadow-sm focus:outline-none focus:ring-[#4ab9cf] focus:border-[#4ab9cf] sm:text-sm"
