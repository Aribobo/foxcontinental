    ...
    <div className="w-full bg-white">
      ...
      <div className="grid grid-cols lg:grid-cols-3">
        ...
        <div className="bg-[#fbf9fa] mr-4 sm:mr-4 ml-4 lg:mt-10 mb-10 rounded-lg ">
          ...
          <p className=" text-[#1f425d] px-4">
          {t('we are')}
    
           </p>
            <br></br>
           <p className="px-4"> <span className="text-[#fd7062] text-xl">{t('mision')}</span></p>
           <p className=" text-[#1f425d] px-4">
           {t('mission')}
             </p>
            <br></br>
            <p className="px-4"> <span className="text-[#fd7062] text-xl">{t('we do')}</span></p>
            <p className="text-[#1f425d] px-4">
            {t('what we doo')}
          </p>
        </div>
